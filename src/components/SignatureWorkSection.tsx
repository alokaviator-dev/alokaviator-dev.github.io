...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: "Lunar Analog-suit",
    titleAccent: "Operations.",
    problem: "Operating in isolation with high dependency on systems and crew coordination.",
    constraint: "Limited dexterity, restricted mobility, and execution under simulated EVA conditions.",
    approach: "Working within suit constraints to execute tasks, validate equipment readiness, and maintain operational continuity under pressure.",
    outcome: "Working within suit constraints to execute tasks, validate equipment readiness, and maintain operational continuity under pressure.",
    image: suitImg,
    status: "TESTING",
    align: "left",
  },
  {
    ...
    problem: "Rover reliability directly impacts mission continuity in isolated environments.",
    constraint: "Limited tools, delayed support, and operation on unknown terrain under mission pressure.",
    approach: "Diagnosing faults, restoring rover functionality, and ensuring operational readiness for surface tasks.",
  ...
  {
    id: "05",
    label: "Interceptor SYSTEMS",
    title: "Prototype",
    titleAccent: "validation.",
    problem: "Simulation protects assumptions.",
    constraint: "Real-time latency, shifting mass distribution, and limited control margins.",
    approach: "Translating pursuit and guidance logic from simulation into a physical test platform under real constraints.",
    outcome: "Exposed failure points in control assumptions and validated system behavior under real-world conditions.",
    image: neuralImg,
    status: "PROTOTYPE",
    align: "left",
  },
