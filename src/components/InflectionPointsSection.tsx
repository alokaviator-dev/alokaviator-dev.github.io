    ...
    >
      ...
      <motion.div style={{ scale: imgScale }} className="absolute inset-0 z-0">
        <img
          ...
          width={1920}
          height={1080}
          className={`w-full h-full object-cover ${point.textRight ? 'object-[25%_center] sm:object-center' : ''}`}
        />
      ...
      <div className="relative z-10 pt-20 sm:pt-32 pb-8 sm:pb-16">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
          <div className="flex items-center gap-4 mb-4">
            ...
            <TextScramble text="INFLECTION POINTS" className="text-mono text-primary/50" delay={0.2} />
          </div>
